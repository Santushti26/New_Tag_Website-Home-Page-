...
export default function Home() {
  ...
  return (
    <motion.div animate={{y:[-1000,0]}}>
      ...
      <FrontPage text1="VELLORE INSTITUTE OF TECHNOLOGY" heading="TAG CLUB" text2="We are the premium gaming and technology club of Vellore Institute of Technology.
